...
pubDate:    2024-09-19 20:37:00 +0300
tags:       dotnet
---
...
![Linqpad shows us exception](../../assets/blog/2024-09-19-linqpad-and-threads/linqpad_error.png)

Here we can see that just using `collection` simply errors out. Let's add `ToArray()`:

![Linqpad shows us exception](../../assets/blog/2024-09-19-linqpad-and-threads/linqpad_success.png)
